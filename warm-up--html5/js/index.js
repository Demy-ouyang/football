(function(){
    ...
    //    if (last.row>1 && last.row<4 && last.col!=3) { now.row = last.row; now.col = last.col+1; pageMove(towards.left);}
    //})
    //
    ...
    //    if (last.row>1 && last.row<4 && last.col!=1) { now.row = last.row; now.col = last.col-1; pageMove(towards.right);}
    //})
